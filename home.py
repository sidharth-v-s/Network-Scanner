...
def resize():
    ...
    dpg.set_item_pos("hlu_button_home", [(width / 2) - 60, (height / 2) - 150])
    dpg.set_item_pos("ps_button_home", [(width / 2) - 60, (height / 2) - 75])
    dpg.set_item_pos("sdf_button_home", [(width / 2) - 60, (height / 2) - 0])
